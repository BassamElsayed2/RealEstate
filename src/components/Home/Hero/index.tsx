    ...
    <section className='!py-0'>
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68'>
          <div className={`relative text-white dark:text-dark ${isArabic ? 'text-center md:text-end' : 'text-center md:text-start'} z-10`}>
            ...
            <div className={`flex flex-col xs:flex-row ${isArabic ? 'justify-center md:justify-end' : 'justify-center md:justify-start'} gap-4`}>
          ...
          <div className={`hidden md:block absolute -top-2 ${isArabic ? '-left-68' : '-right-68'}`}>
            <Image
        ...
        <div className={`md:absolute bottom-0 ${isArabic ? 'md:-left-68 xl:left-0' : 'md:-right-68 xl:right-0'} bg-white dark:bg-black py-12 px-8 mobile:px-16 ${isArabic ? 'md:pr-16 md:pl-[295px]' : 'md:pl-16 md:pr-[295px]'} rounded-2xl md:rounded-none ${isArabic ? 'md:rounded-tr-2xl' : 'md:rounded-tl-2xl'} mt-24`}>
